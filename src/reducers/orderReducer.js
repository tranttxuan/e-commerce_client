...
export const orderSellerListReducer = (state = { orders: [] }, action) => {
    switch (action.type) {
        case ORDER_SELLER_LIST_REQUEST:
            return { loading: true };
        case ORDER_SELLER_LIST_SUCCESS:
            return { loading: false, orders: action.payload }
        case ORDER_SELLER_LIST_FAIL:
            return { loading: false, error: action.payload }
        default:
            return state
    }
